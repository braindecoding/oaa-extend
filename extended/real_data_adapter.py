...
from multi_subject_vangerven import MultiSubjectVangerven
...
class RealDataAdapter:
    ...
    def test_multi_subject_vangerven_with_real_data(self):
        """Test MultiSubjectVangerven with real data"""
        print(f"\n{'='*60}")
        print("TESTING MULTI-SUBJECT VANGERVEN WITH REAL DATA")
        print(f"{'='*60}")
        ...
        for method in alignment_methods:
            print(f"\n--- Testing MultiSubjectVangerven with {method} ---")
            ...
            try:
                ...
                if method == 'ridge':
                    ...
                    params = {'n_components': 30, 'max_iterations': 3, 'normalize': False}
                else:
                    params = {}

                # Initialize MultiSubjectVangerven
                ...
                # Train
                ms_vangerven.fit(multi_subject_data)
                ...
                print(f"✓ {method} MultiSubjectVangerven completed")
                print(f"  Input fMRI shape: {test_fmri.shape}")
                print(f"  Prediction shape: {predictions.shape}")

            except Exception as e:
                print(f"✗ {method} MultiSubjectVangerven failed: {str(e)}")
...
def main():
    ...
    try:
        ...
        # Test MultiSubjectVangerven
        print("\n4. Testing MultiSubjectVangerven with real data...")
        adapter.test_multi_subject_vangerven_with_real_data()
        print("✓ MultiSubjectVangerven testing completed")
